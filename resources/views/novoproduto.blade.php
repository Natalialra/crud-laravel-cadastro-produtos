        ...
        <div class="card-body">
            <form action="{{ route('produtos.store') }}" method="POST">
                ...
                <div class="form-group ">
                    <div class="row ">
                        <div class="col-5">
                            <label for="nomeProduto" class="ms-2">Nome do Produto</label>
                            <input type="text" name="nomeProduto" class="form-control mt-3" id="nomeProduto">
                        </div>
                        <div class="col-2">
                            <label for="precoProduto" class="ms-2">Preço</label>
                            <input type="number" name="precoProduto" class="form-control mt-3" id="precoProduto">
                        </div>
                        <div class="col-5">
